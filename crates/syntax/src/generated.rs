...
pub enum TSKind {
    ...
    string_literal = 240,
    rest_operator = 241,
    anon_source_file_repeat1_ = 242,
    anon_preproc_macro_repeat1_ = 243,
    anon_function_definition_repeat1_ = 244,
    anon_parameter_declarations_repeat1_ = 245,
    anon_parameter_declaration_repeat1_ = 246,
    anon_global_variable_declaration_repeat1_ = 247,
    anon_variable_declaration_statement_repeat1_ = 248,
    anon_dynamic_array_repeat1_ = 249,
    anon_old_global_variable_declaration_repeat1_ = 250,
    anon_enum_entries_repeat1_ = 251,
    anon_enum_struct_repeat1_ = 252,
    anon_typeset_repeat1_ = 253,
    anon_funcenum_repeat1_ = 254,
    anon_methodmap_repeat1_ = 255,
    anon_methodmap_property_repeat1_ = 256,
    anon_struct_repeat1_ = 257,
    anon_struct_constructor_repeat1_ = 258,
    anon_block_repeat1_ = 259,
    anon_for_statement_repeat1_ = 260,
    anon_switch_statement_repeat1_ = 261,
    anon_switch_case_repeat1_ = 262,
    anon_call_arguments_repeat1_ = 263,
    anon_array_literal_repeat1_ = 264,
    anon_string_literal_repeat1_ = 265,
}
