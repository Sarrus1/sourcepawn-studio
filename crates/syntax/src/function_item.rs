...
pub struct FunctionItem {
    ...
    /// [FileId](FileId) of the file where the function is declared.
    pub file_id: FileId,
...
impl FunctionItem {
    ...
    pub fn to_signature_help(&self, parameter_count: u32) -> Option<SignatureInformation> {
        ...
        Some(SignatureInformation {
            ...
            documentation: self.description.to_md().map(|description| {
    ...
    pub fn to_call_hierarchy(&self) -> CallHierarchyItem {
        CallHierarchyItem {
